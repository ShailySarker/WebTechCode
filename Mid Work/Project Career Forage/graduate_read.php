<html>
	...
	<center>
	<body>
		<h1>Read the Users of Graduate Student:</h1>
		<table>
			<tr>
				<td> <a href="graduate_student_user.php">Graduate Student User Info</a> </td>
			</tr>
			...
			<?php 
				$users = simplexml_load_file("graduateusers.xml");
