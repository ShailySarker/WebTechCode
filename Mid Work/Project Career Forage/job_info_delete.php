...
<?php
	include_once"job_info_delete_validation.php";
?>
<html>
	<center>
		...
		<fieldset>
			...
			<form action="" method="post">
				<table>
					...
					<tr>
						<td>
						<button type="submit" style="color:red" name="submit"><strong>Delete a Job Info</strong></button> </td>
