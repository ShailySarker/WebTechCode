<?php
	include_once "internship_info_update_validation.php";
?>
...
<html>
	...
	<fieldset style="background-color:powderblue;height:80%;width:40%">
		...
		<body>
		<fieldset>
			<h3>Update an Internship Info</h3>
			<form action="" method="post">
				<table>
					...
					<tr>
						...
						<td align="center"><strong>Want to update?</strong> 
					...
					<tr>
						<td>
						<button type="submit" style="color:blue" name="submit"><strong>Update a Internship Info</strong></button> </td>
