<?php
	include_once "job_info_update_validation.php";
?>	
<html>
	<center>
		...
		<fieldset>
			...
			<form action="" method="post">
				<table>
					...
					<tr>
						<td>
						<button type="submit" style="color:blue" name="submit"><strong>Update a Job Info</strong></button> </td>
