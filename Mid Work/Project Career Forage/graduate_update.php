<?php
	include_once"graduate_update_validation.php";
?>
			...
			<form action="" method="post">
				<table>
					...
					<tr>
						...
						<td><input type="text" style="height:30px;width:108px" placeholder="City" value="<?php echo $city?>" name="city">-<input type="text" style="height:30px;width:107px"placeholder="State" value="<?php echo $state?>" name="state" size="8"></td>
						<td><span style="color:red;"><?php echo $err_address;?></span></td>
					</tr>
					<tr>
